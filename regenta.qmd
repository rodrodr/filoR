...
# Aquí buscar los datos en la 
# carpeta que habéis guardado los 
# datos al ejecutar los códigos
# de preparación, algo como
...
De ese modo, las palabras que se encuentren lo más lejos del eje horizontal y vertical serán las más específicas del capítulo. Por otra parte, aquellas que se encuentren más a la derecha, son las más frecuentes en el capítulo 8. Por lo tanto, términos como "visita", "cocina", "marqués" se destacan tanto por su particular incidencia en el capítulo, como por su alta frecuencia. También vemos en rojo las palabras menos empleadas que lo esperado.
...
Los siguientes códigos generan dos gráficos de dispersión léxica, utilizando un diccionario con palabras clave asociadas a los temas de espacio y tiempo.
...
dicf <- dictionary(
  list(
    ...
    religioso=c("catedral","capilla","sacristía",
                "claustro","seminario"),
    doméstico=c("\\bcasa\\b","hogar","alcoba",
...
Otra manera de verlo es por medio de un gráfico de símbolos proporcionales organizados en una grada de N personajes por N capítulos. En este caso, la función `plotGrid` del paquete `tenet` nos permite hacerlo de manera sencilla: 
