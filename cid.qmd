...
ag <- aggregate(Texto ~ personaje_A, 
                data = cid_d, 
                FUN = paste,
                collapse = "\n")
...
cp <- corpus(ag, text_field = "Texto", docid_field = "personaje_A")
...
cid_d$id <- 1:nrow(cid_d)

# Convierte en corpus el dataframe sin
# los textos de introducción
cs <- corpus(cid_d[cid_d$personaje_A!="Introducción",], 
             text_field = "Texto",
             docid_field = "id")
...
emo <- get_nrc_sentiment(cid_d$Texto, 
                         language = "spanish")
